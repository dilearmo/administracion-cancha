class PruebasDeUsuario extends CI_Controller {
    ...
    
    {
       ...
       // return $this->Prueba_obtenerUsuariosAdmUsuConfNoConf('Listar usuarios NO confiables de la aplicacion', 'Consulta todos los usuarios NO confiables de la aplicacion de la BD','habilitado','0');
     ...
     public function Prueba_obtenerUsuariosAdmUsuConfNoConf($nombrePrueba, $descripcionTest, $nombreTabla, $habilitados) 
     {
       $test_name = $nombrePrueba;
       $test_notes= $descripcionTest;
       $this->unit->run($this->Usuario_model->obtenerUsuariosAdmUsuConfNoConf($nombreTabla, $habilitados), true, $test_name, $test_notes);
       echo $this->unit->report();
    }
